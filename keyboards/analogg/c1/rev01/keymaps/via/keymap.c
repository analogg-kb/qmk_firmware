// Copyright 2021 Jaypei (jaypei97159@gmail.com)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_81_ansi(
        EE_CLR,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  DB_TOGG,  QK_RBT,   QK_BOOT,  _______,  RGB_TOG, RGB_RMOD, RGB_MOD,
